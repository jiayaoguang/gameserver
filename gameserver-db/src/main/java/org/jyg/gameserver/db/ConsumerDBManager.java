...
//
    ...
    public void insert(BaseDBEntity dbEntity) {
        ...
        gameConsumer.getGameContext().getConsumerManager().publishEvent(dbConsumerId, consumerDefaultEvent, dbEntity.getClass().getSimpleName());
    }
    ...
    public void insert(BaseDBEntity dbEntity, String childChooseId) {
        ...
        gameConsumer.getGameContext().getConsumerManager().publishEvent(dbConsumerId, consumerDefaultEvent, childChooseId);
    }
