 ...
 * 重定义类
 */
public class RetransformClassesHttpProcessor extends HttpProcessor {


    public RetransformClassesHttpProcessor() {
        super("/reTransformClasses");
    }
...
//                    e.printStackTrace();
                ...
                if(clazz != null){
                    ...
                    ClassRedefineUtil.reTransform(redefineClass, classBytes);
                    Logs.DEFAULT_LOGGER.info(" redefine class success file {}  class {}", childClassFile.getAbsolutePath(), className);
                ...
                Logs.DEFAULT_LOGGER.info(" redefine class fail file {}  msg : {}", childClassFile.getAbsolutePath(), exceptionMsg);
                sendMsgSb.append("redefine file :").append(childClassFile.getAbsolutePath()).append("fail exceptionMsg : ").append(exceptionMsg);
            }
        }
        sendMsgSb.append("</pre>");
